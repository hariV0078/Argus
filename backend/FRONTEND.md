...
> **Superseded by the real implementation at [`../frontend`](../frontend) (Argus).** This doc is kept as the original spec/reference; the app it describes has since been built and matches this API surface almost exactly.
